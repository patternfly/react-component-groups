...
const cards = [
  <Card isFullHeight isPlain key="card-1">
    ...
    <CardBody>
      <TextContent>
        <Text className="pf-v6-u-font-size-sm pf-v6-u-font-weight-bold pf-v6-u-mb-sm pf-v6-u-link-color-hover">
    ...
    <CardFooter>
      <TextContent>
        <TextList className="pf-v6-u-font-size-sm pf-v6-u-link-color pf-v6-u-ml-0">
          <TextListItem>
